            ...
            <div class="caja">
                ...
                <div id="sabado" class="contenido-dia clearfix">
                    ...
                    <div class="content-day">
                        ...
                        <div>
                            <p>Conferencias:</p>
                            <label><input type="checkbox" name="registro[]" id="conf_04" value="conf_04"><time>10:00</time> Como crear una tienda online que venda
                                millones
                                en pocos días</label>
                ...
                <div id="domingo" class="contenido-dia clearfix">
                    ...
                    <div class="content-day">
                        ...
                        <div>
                            <p>Seminarios:</p>
                            <label><input type="checkbox" name="registro[]" id="sem_04" value="sem_04"><time>14:00</time> Creando una App en Android en una
                                tarde</label>
